...
var drawJSROOT = function drawJSROOT(histogramParam, plot_name, overlaidJSROOTPlot) {
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.async(function drawJSROOT$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          //@ts-ignore
          JSROOT.draw("".concat(histogramParam, "_").concat(plot_name), //@ts-ignore
...
//# sourceMappingURL=index.js.7e9b9911bbbd78588b0d.hot-update.js.map