...
var drawJSROOTHist = function drawJSROOTHist(data, plotName) {
  //@ts-ignore
  JSROOT.draw(plotName, JSROOT.parse(JSON.stringify(data)), 'hist');
};
...
var ZoomedJSROOTPlot = function ZoomedJSROOTPlot(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    drawJSROOTHist(data, selected_plot.name);
  }, [data, params_for_api]);
...
//# sourceMappingURL=index.js.f558c9b8f063b51d84d6.hot-update.js.map