...
var ZoomedJSROOTPlot = function ZoomedJSROOTPlot(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    JSROOT.cleanup("".concat(selected_plot.name).concat(query.run_number).concat(query.lumi)); //@ts-ignore
    // JSROOT.draw(`${selected_plot.name}${query.run_number}${query.lumi}`, JSROOT.parse(JSON.stringify(data)), 'hist');
  }, [data, params_for_api]);
...
//# sourceMappingURL=index.js.f5a236fe67d8f83282ec.hot-update.js.map