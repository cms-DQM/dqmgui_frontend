...
export const useFilterFolders = (query: QueryProps, allDirectories: any[]) => {
    ...
    const { directories, plots, isLoading, errors } = usePlotSearch(plot_name, query.run_number, query.dataset_name, query.folder_path)
    ...
    React.useEffect(() => {
        ...
        const foldersFromWorkspaces = filteredFolders.length > 0 ? filteredFolders : allDirectories
