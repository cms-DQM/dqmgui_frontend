...
export const useUpdateLiveMode = (errors: any[]) => {
  ...
  const data_is_selected = !!query.run_number && !!query.dataset_name || !!query.search_dataset_name || !!query.search_run_number
  ...
  const latest_runs_list = online_mode && functions_config.new_back_end.latest_runs && !query.search_dataset_name && !query.search_run_number && errors.length === 0 && !data_is_selected
