...
export const StyledTableRow = styled.tr`
    width: 100%;
    background: ${props => props?.index && props.index % 2 === 0 || props.index === 0 ? `${theme.colors.thirdy.light}` : ''};
    cursor: pointer;
    &:hover {
        background-color:  ${props => props?.noHover ? '' : `${theme.colors.secondary.light}`}
    }
`
...
export const ExpandedRow = styled.div`
    font-weight: ${props => props?.expanded && props.expanded === true ? 'bold' : ''}
`