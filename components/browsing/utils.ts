...
export const getAvailableChoices = (resultsNames: any, name: any, part: string): string[] => {
  ...
  const available: string[] = resultsNames[name] ? _.uniq(resultsNames[name].map((datasetname: any) => datasetname[part])) : []
