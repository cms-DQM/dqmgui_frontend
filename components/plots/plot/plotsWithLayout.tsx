...
import { PlotsGroupedByLayoutsInterface, PlotDataProps, QueryProps } from '../../../containers/display/interfaces';
                ...
                {name !== 'default' ?
                  ...
                  >
                    ...
                    <CustomDiv color={`${theme.colors.common.white}`}>
                      {shrinkLayouts.includes(name) ? <UpOutlined /> : <DownOutlined />}</CustomDiv>
                  </CustomCol>
                  :
                  <CustomCol
                    width="100%"
